...
<img src="https://avatars.githubusercontent.com/u/119033939?v=4" width="150px" style="border-radius:50%;" />
...
<img src="https://komarev.com/ghpvc/?username=fufex3934&label=Profile%20Views&color=6e40c9&style=flat"/>
</a>
</p>
...
I’m a **Backend-focused Full Stack Developer** passionate about building **scalable APIs, secure authentication systems, and real-time applications**.

I enjoy designing **clean backend architectures** using modern technologies such as **NestJS, Node.js, and TypeScript**.
...
I help startups and companies build **robust backend systems and APIs**.

### Backend Services I Offer
...
> Contributed as **Backend Developer** for the Seed E-commerce platform (NestJS backend).  

**Responsibilities & Features:**
- Built secure and modular **NestJS backend**  
- Implemented **authentication, authorization, and role-based access**  
- Designed and implemented **API endpoints** for products, cart, orders, and payments  
- Worked in a **monorepo setup** with shared packages across frontend & backend  

**Tech:** NestJS · PostgreSQL · Prisma · REST API  

**Note:** Repository is private (organization-owned), but I contributed backend functionality.  
...
- Authentication, product, cart, order management  
...
### 🔐 Authentication API
- JWT authentication  
- Refresh tokens & role-based access  
- Protected routes  
...
### 💬 Real-Time Chat API
- Real-time chat backend using WebSockets  
...
Building a full-featured digital platform for schools including:  
- Student management  
- Online classroom  
- Fees management  
- E-learning & exams  
...
**Tech Stack:** Laravel · Inertia.js · MySQL · TailwindCSS
...
💼 LinkedIn: [https://linkedin.com/in/fufa-wakgari-85b412228](https://linkedin.com/in/fufa-wakgari-85b412228)  
🌐 Portfolio: [https://fufawakgari.vercel.app](https://fufawakgari.vercel.app)
